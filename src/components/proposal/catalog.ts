...
export const CATALOG: CatalogItem[] = [
  ...
  publicItem({ id: 'floor-wide-greige', slot: 'floor', section: 'finish', nameJa: '巾広フローリング', nameEn: 'Wide-plank flooring', specificationJa: '朝日建設の公開 Standard＋仕様を基にした提案。メーカー・品番は要確認', specificationEn: 'Proposal based on Asahi Standard+ public specification; maker and SKU require confirmation', size: '巾広タイプ / wide plank', colorJa: 'グレージュオーク（提案色）', colorEn: 'Greige oak (proposed)', manufacturerJa: '要確認', manufacturerEn: 'To be confirmed', unitJa: 'm²', unitEn: 'm²', swatch: '#c0b3a1', status: 'standardPlus' }),
  publicItem({ id: 'floor-herringbone-oak', slot: 'floor', section: 'finish', nameJa: 'ヘリンボーンフローリング', nameEn: 'Herringbone flooring', specificationJa: '朝日建設の公開 Standard＋仕様を基にした提案。メーカー・品番は要確認', specificationEn: 'Proposal based on Asahi Standard+ public specification; maker and SKU require confirmation', size: 'ヘリンボーン張り / herringbone lay', colorJa: 'オーク（提案色）', colorEn: 'Oak (proposed)', manufacturerJa: '要確認', manufacturerEn: 'To be confirmed', unitJa: 'm²', unitEn: 'm²', swatch: '#c99a63', status: 'option' }),
  publicItem({ id: 'floor-tile-stone', slot: 'floor', section: 'finish', nameJa: '石目調フロアタイル', nameEn: 'Stone-look floor tile', specificationJa: '朝日建設の公開 Standard＋仕様を基にした提案。メーカー・品番は要確認', specificationEn: 'Proposal based on Asahi Standard+ public specification; maker and SKU require confirmation', size: '600角相当 / 600 mm module', colorJa: 'ライトストーン（提案色）', colorEn: 'Light stone (proposed)', manufacturerJa: '要確認', manufacturerEn: 'To be confirmed', unitJa: 'm²', unitEn: 'm²', swatch: '#d8d6d0', status: 'option' }),
  ...
  publicItem({ id: 'wall-accent-charcoal', slot: 'walls', section: 'finish', nameJa: 'アクセントクロス', nameEn: 'Accent wallpaper', specificationJa: '公開 Standard＋仕様の1面アクセントクロス。品番は要確認', specificationEn: 'One-wall accent wallpaper from the public Standard+ specification; SKU requires confirmation', size: '1面 / one wall', colorJa: 'チャコール（提案色）', colorEn: 'Charcoal (proposed)', manufacturerJa: '要確認', manufacturerEn: 'To be confirmed', unitJa: 'm²', unitEn: 'm²', swatch: '#4a4b49', status: 'standardPlus', sourceUrl: ASAHI_SPEC_URL }),
  publicItem({ id: 'wall-accent-sage', slot: 'walls', section: 'finish', nameJa: 'アクセントクロス', nameEn: 'Accent wallpaper', specificationJa: '公開 Standard＋仕様の1面アクセントクロス。品番は要確認', specificationEn: 'One-wall accent wallpaper from the public Standard+ specification; SKU requires confirmation', size: '1面 / one wall', colorJa: 'セージグリーン（提案色）', colorEn: 'Sage green (proposed)', manufacturerJa: '要確認', manufacturerEn: 'To be confirmed', unitJa: 'm²', unitEn: 'm²', swatch: '#9aa78f', status: 'standardPlus', sourceUrl: ASAHI_SPEC_URL }),
  publicItem({ id: 'wall-wood-panel', slot: 'walls', section: 'finish', nameJa: '木質パネル', nameEn: 'Wood wall panel', specificationJa: '公開 Standard＋仕様の1面アクセントクロス。品番は要確認', specificationEn: 'One-wall accent wallpaper from the public Standard+ specification; SKU requires confirmation', size: '1面 / one wall', colorJa: 'オーク木目（提案色）', colorEn: 'Oak woodgrain (proposed)', manufacturerJa: '要確認', manufacturerEn: 'To be confirmed', unitJa: 'm²', unitEn: 'm²', swatch: '#b98a55', status: 'option', sourceUrl: ASAHI_SPEC_URL }),
  ...
  referenceFurniture({ id: 'accessory-dining-chairs', nameJa: 'ダイニングチェア4脚', nameEn: 'Four dining chairs', specificationJa: '空間確認用の参考家具。朝日建設の取扱・メーカー・品番は未確認', specificationEn: 'Reference staging item; Asahi supply, maker, and SKU are not confirmed', size: 'W 450 × D 520（参考）', colorJa: 'オーク＋ファブリック（提案色）', colorEn: 'Oak with fabric (proposed)', unitJa: '脚', unitEn: 'ea', swatch: '#bb9a6e' }),
  referenceFurniture({ id: 'accessory-tv-board', nameJa: 'TVボード', nameEn: 'TV board', specificationJa: '空間確認用の参考家具。朝日建設の取扱・メーカー・品番は未確認', specificationEn: 'Reference staging item; Asahi supply, maker, and SKU are not confirmed', size: 'W 1800 × D 400（参考）', colorJa: 'ウォームグレー（提案色）', colorEn: 'Warm gray (proposed)', unitJa: '台', unitEn: 'ea', swatch: '#9e9a94' }),
  referenceFurniture({ id: 'accessory-shelf', nameJa: 'オープンシェルフ', nameEn: 'Open shelving', specificationJa: '空間確認用の参考家具。朝日建設の取扱・メーカー・品番は未確認', specificationEn: 'Reference staging item; Asahi supply, maker, and SKU are not confirmed', size: 'W 900 × H 1800（参考）', colorJa: 'ナチュラル木目（提案色）', colorEn: 'Natural wood (proposed)', unitJa: '台', unitEn: 'ea', swatch: '#b98d5e' }),
  referenceFurniture({ id: 'accessory-floor-lamp', nameJa: 'フロアランプ', nameEn: 'Floor lamp', specificationJa: '空間確認用の参考家具。朝日建設の取扱・メーカー・品番は未確認', specificationEn: 'Reference staging item; Asahi supply, maker, and SKU are not confirmed', size: 'H 1600 mm（参考）', colorJa: 'ブラック＋リネンシェード（提案色）', colorEn: 'Black with linen shade (proposed)', unitJa: '台', unitEn: 'ea', swatch: '#6f6b64' }),
  referenceFurniture({ id: 'accessory-artwork', nameJa: 'アートパネル', nameEn: 'Art panel', specificationJa: '空間確認用の参考家具。朝日建設の取扱・メーカー・品番は未確認', specificationEn: 'Reference staging item; Asahi supply, maker, and SKU are not confirmed', size: 'W 900 × H 600（参考）', colorJa: 'モノトーン（提案）', colorEn: 'Monotone (proposed)', unitJa: '点', unitEn: 'ea', swatch: '#cfcbc4' }),
  referenceFurniture({ id: 'accessory-bedside', nameJa: 'ナイトテーブル', nameEn: 'Bedside table', specificationJa: '空間確認用の参考家具。朝日建設の取扱・メーカー・品番は未確認', specificationEn: 'Reference staging item; Asahi supply, maker, and SKU are not confirmed', size: 'W 450 × D 400（参考）', colorJa: 'ナチュラル木目（提案色）', colorEn: 'Natural wood (proposed)', unitJa: '台', unitEn: 'ea', swatch: '#c2a077' }),
];
